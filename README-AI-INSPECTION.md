...
1. Apply `supabase/migrations/202609260005_hide_internal_inspection_data.sql` to the Supabase project before deploying this feature. It updates the customer-code RPC to hide the internal inspection field.
